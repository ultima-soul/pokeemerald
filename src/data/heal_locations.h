static const struct HealLocation sHealLocations[] =
{
    ...
    {MAP_GROUP(PETALBURG_CITY), MAP_NUM(PETALBURG_CITY), 27, 25},
    {MAP_GROUP(SLATEPORT_CITY), MAP_NUM(SLATEPORT_CITY), 9, 29},
    {MAP_GROUP(MAUVILLE_CITY), MAP_NUM(MAUVILLE_CITY), 33, 28},
    {MAP_GROUP(RUSTBORO_CITY), MAP_NUM(RUSTBORO_CITY), 24, 25},
    {MAP_GROUP(FORTREE_CITY), MAP_NUM(FORTREE_CITY), 14, 9},
