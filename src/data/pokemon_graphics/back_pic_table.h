const struct CompressedSpriteSheet gMonBackPicTable[] =
{
    ...
    SPECIES_SPRITE(PIKACHU_COSPLAY, gMonBackPic_Pikachu),
    SPECIES_SPRITE(PIKACHU_ROCK_STAR, gMonBackPic_Pikachu),
    SPECIES_SPRITE(PIKACHU_BELLE, gMonBackPic_Pikachu),
    SPECIES_SPRITE(PIKACHU_POP_STAR, gMonBackPic_Pikachu),
    SPECIES_SPRITE(PIKACHU_PH_D, gMonBackPic_Pikachu),
    SPECIES_SPRITE(PIKACHU_LIBRE, gMonBackPic_Pikachu),
    
    SPECIES_SPRITE(PIKACHU_ORIGINAL_CAP, gMonBackPic_Pikachu),
    SPECIES_SPRITE(PIKACHU_HOENN_CAP, gMonBackPic_Pikachu),
    SPECIES_SPRITE(PIKACHU_SINNOH_CAP, gMonBackPic_Pikachu),
    SPECIES_SPRITE(PIKACHU_UNOVA_CAP, gMonBackPic_Pikachu),
    SPECIES_SPRITE(PIKACHU_KALOS_CAP, gMonBackPic_Pikachu),
    SPECIES_SPRITE(PIKACHU_ALOLA_CAP, gMonBackPic_Pikachu),
    SPECIES_SPRITE(PIKACHU_PARTNER_CAP, gMonBackPic_Pikachu),
    
    SPECIES_SPRITE(PICHU_SPIKY_EARED, gMonBackPic_Pichu),
    ...
    SPECIES_SPRITE(CASTFORM_SUNNY, gMonBackPic_Castform),
    SPECIES_SPRITE(CASTFORM_RAINY, gMonBackPic_Castform),
    SPECIES_SPRITE(CASTFORM_SNOWY, gMonBackPic_Castform),
    
    SPECIES_SPRITE(DEOXYS_ATTACK, gMonBackPic_Deoxys),
    SPECIES_SPRITE(DEOXYS_DEFENSE, gMonBackPic_Deoxys),
    SPECIES_SPRITE(DEOXYS_SPEED, gMonBackPic_Deoxys),
    
    SPECIES_SPRITE(BURMY_SANDY_CLOAK, gMonBackPic_BurmySandy),
    SPECIES_SPRITE(BURMY_TRASH_CLOAK, gMonBackPic_BurmyTrash),

    SPECIES_SPRITE(WORMADAM_SANDY_CLOAK, gMonBackPic_WormadamSandy),
    SPECIES_SPRITE(WORMADAM_TRASH_CLOAK, gMonBackPic_WormadamTrash),

    SPECIES_SPRITE(CHERRIM_SUNSHINE, gMonBackPic_Cherrim),

    SPECIES_SPRITE(SHELLOS_EAST_SEA, gMonBackPic_ShellosE),
    
    SPECIES_SPRITE(GASTRODON_EAST_SEA, gMonBackPic_GastrodonE),
    ...
    SPECIES_SPRITE(BASCULIN_BLUE_STRIPED, gMonBackPic_Basculin),

    SPECIES_SPRITE(DARMANITAN_ZEN_MODE, gMonBackPic_DarmanitanZen),
    ...
    SPECIES_SPRITE(SAWSBUCK_SUMMER, gMonBackPic_Sawsbuck),
    SPECIES_SPRITE(SAWSBUCK_AUTUMN, gMonBackPic_Sawsbuck),
    SPECIES_SPRITE(SAWSBUCK_WINTER, gMonBackPic_Sawsbuck),
    ...
    SPECIES_SPRITE(KELDEO_RESOLUTE, gMonBackPic_Keldeo),
    ...
    SPECIES_SPRITE(GRENINJA_ASH, gMonBackPic_Greninja),

    SPECIES_SPRITE(VIVILLON_POLAR, gMonBackPic_Vivillon),
    SPECIES_SPRITE(VIVILLON_TUNDRA, gMonBackPic_Vivillon),
    SPECIES_SPRITE(VIVILLON_CONTINENTAL, gMonBackPic_Vivillon),
    SPECIES_SPRITE(VIVILLON_GARDEN, gMonBackPic_Vivillon),
    SPECIES_SPRITE(VIVILLON_ELEGANT, gMonBackPic_Vivillon),
    SPECIES_SPRITE(VIVILLON_MEADOW, gMonBackPic_Vivillon),
    SPECIES_SPRITE(VIVILLON_MODERN, gMonBackPic_Vivillon),
    SPECIES_SPRITE(VIVILLON_MARINE, gMonBackPic_Vivillon),
    SPECIES_SPRITE(VIVILLON_ARCHIPELAGO, gMonBackPic_Vivillon),
    SPECIES_SPRITE(VIVILLON_HIGH_PLAINS, gMonBackPic_Vivillon),
    SPECIES_SPRITE(VIVILLON_SANDSTORM, gMonBackPic_Vivillon),
    SPECIES_SPRITE(VIVILLON_RIVER, gMonBackPic_Vivillon),
    SPECIES_SPRITE(VIVILLON_MONSOON, gMonBackPic_Vivillon),
    SPECIES_SPRITE(VIVILLON_SAVANNA, gMonBackPic_Vivillon),
    SPECIES_SPRITE(VIVILLON_SUN, gMonBackPic_Vivillon),
    SPECIES_SPRITE(VIVILLON_OCEAN, gMonBackPic_Vivillon),
    SPECIES_SPRITE(VIVILLON_JUNGLE, gMonBackPic_Vivillon),
    SPECIES_SPRITE(VIVILLON_FANCY, gMonBackPic_Vivillon),
    SPECIES_SPRITE(VIVILLON_POKE_BALL, gMonBackPic_Vivillon),
    ...
    SPECIES_SPRITE(FLOETTE_ETERNAL_FLOWER, gMonBackPic_Floette),
    ...
    SPECIES_SPRITE(FURFROU_HEART_TRIM, gMonBackPic_Furfrou),
    SPECIES_SPRITE(FURFROU_STAR_TRIM, gMonBackPic_Furfrou),
    SPECIES_SPRITE(FURFROU_DIAMOND_TRIM, gMonBackPic_Furfrou),
    SPECIES_SPRITE(FURFROU_DEBUTANTE_TRIM, gMonBackPic_Furfrou),
    SPECIES_SPRITE(FURFROU_MATRON_TRIM, gMonBackPic_Furfrou),
    SPECIES_SPRITE(FURFROU_DANDY_TRIM, gMonBackPic_Furfrou),
    SPECIES_SPRITE(FURFROU_LA_REINE_TRIM, gMonBackPic_Furfrou),
    SPECIES_SPRITE(FURFROU_KABUKI_TRIM, gMonBackPic_Furfrou),
    SPECIES_SPRITE(FURFROU_PHARAOH_TRIM, gMonBackPic_Furfrou),

    SPECIES_SPRITE(MEOWSTIC_F, gMonBackPic_MeowsticFemale),

    SPECIES_SPRITE(AEGISLASH_BLADE, gMonBackPic_AegislashBlade),

    SPECIES_SPRITE(PUMPKABOO_SMALL, gMonBackPic_Pumpkaboo),
    SPECIES_SPRITE(PUMPKABOO_LARGE, gMonBackPic_Pumpkaboo),
    SPECIES_SPRITE(PUMPKABOO_SUPER, gMonBackPic_Pumpkaboo),

    SPECIES_SPRITE(GOURGEIST_SMALL, gMonBackPic_Gourgeist),
    SPECIES_SPRITE(GOURGEIST_LARGE, gMonBackPic_Gourgeist),
    SPECIES_SPRITE(GOURGEIST_SUPER, gMonBackPic_Gourgeist),

    SPECIES_SPRITE(XERNEAS_ACTIVE, gMonBackPic_Xerneas),
    ...
    SPECIES_SPRITE(ORICORIO_POM_POM, gMonBackPic_Oricorio),
    SPECIES_SPRITE(ORICORIO_PA_U, gMonBackPic_Oricorio),
    SPECIES_SPRITE(ORICORIO_SENSU, gMonBackPic_Oricorio),
    ...
    SPECIES_SPRITE(NECROZMA_DUSK_MANE, gMonBackPic_Necrozma),
    SPECIES_SPRITE(NECROZMA_DAWN_WINGS, gMonBackPic_Necrozma),
    SPECIES_SPRITE(NECROZMA_ULTRA, gMonBackPic_Necrozma),

    SPECIES_SPRITE(MAGEARNA_ORIGINAL_COLOR, gMonBackPic_Magearna),
