const struct CompressedSpriteSheet gMonBackPicTable[] =
{
    ...
    SPECIES_SPRITE(UNOWN_B, gMonBackPic_Bonded_Altaria),
    SPECIES_SPRITE(UNOWN_C, gMonBackPic_Bonded_Ampharos),
    SPECIES_SPRITE(UNOWN_D, gMonBackPic_Bonded_Audino),
    SPECIES_SPRITE(UNOWN_E, gMonBackPic_Bonded_Beedrill),
    SPECIES_SPRITE(UNOWN_F, gMonBackPic_Bonded_Blastoise),
    SPECIES_SPRITE(UNOWN_G, gMonBackPic_Bonded_Blaziken),
    SPECIES_SPRITE(UNOWN_H, gMonBackPic_Bonded_Charizard_y),
    SPECIES_SPRITE(UNOWN_I, gMonBackPic_Bonded_Gallade),
    SPECIES_SPRITE(UNOWN_J, gMonBackPic_Bonded_Garchomp),
    SPECIES_SPRITE(UNOWN_K, gMonBackPic_Bonded_Gardevoir),
    SPECIES_SPRITE(UNOWN_L, gMonBackPic_Bonded_Gengar),
    SPECIES_SPRITE(UNOWN_M, gMonBackPic_Bonded_Glalie),
    SPECIES_SPRITE(UNOWN_N, gMonBackPic_Bonded_Gyarados),
    SPECIES_SPRITE(UNOWN_O, gMonBackPic_Bonded_Heracross),
    SPECIES_SPRITE(UNOWN_P, gMonBackPic_Bonded_Lopunny),
    SPECIES_SPRITE(UNOWN_Q, gMonBackPic_Bonded_Lucario),
    SPECIES_SPRITE(UNOWN_R, gMonBackPic_Bonded_Metagross),
    SPECIES_SPRITE(UNOWN_S, gMonBackPic_Bonded_Pidgeot),
    SPECIES_SPRITE(UNOWN_T, gMonBackPic_Bonded_Pinsir),
    SPECIES_SPRITE(UNOWN_U, gMonBackPic_Bonded_Mewtwo_x),
    SPECIES_SPRITE(UNOWN_V, gMonBackPic_Bonded_Salamence),
    SPECIES_SPRITE(UNOWN_W, gMonBackPic_Bonded_Sceptile),
    SPECIES_SPRITE(UNOWN_X, gMonBackPic_Bonded_Scizor),
    SPECIES_SPRITE(UNOWN_Y, gMonBackPic_Bonded_Steelix),
    SPECIES_SPRITE(UNOWN_Z, gMonBackPic_Bonded_Swampert),
    SPECIES_SPRITE(UNOWN_EMARK, gMonBackPic_Bonded_Tyranitar),
    SPECIES_SPRITE(UNOWN_QMARK, gMonBackPic_Bonded_Venusaur),
};
