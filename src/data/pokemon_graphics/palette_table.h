const struct CompressedSpritePalette gMonPaletteTable[] =
{
    ...
    SPECIES_PAL(PIKACHU_COSPLAY, gMonPalette_Pikachu),
    SPECIES_PAL(PIKACHU_ROCK_STAR, gMonPalette_Pikachu),
    SPECIES_PAL(PIKACHU_BELLE, gMonPalette_Pikachu),
    SPECIES_PAL(PIKACHU_POP_STAR, gMonPalette_Pikachu),
    SPECIES_PAL(PIKACHU_PH_D, gMonPalette_Pikachu),
    SPECIES_PAL(PIKACHU_LIBRE, gMonPalette_Pikachu),
    
    SPECIES_PAL(PIKACHU_ORIGINAL_CAP, gMonPalette_Pikachu),
    SPECIES_PAL(PIKACHU_HOENN_CAP, gMonPalette_Pikachu),
    SPECIES_PAL(PIKACHU_SINNOH_CAP, gMonPalette_Pikachu),
    SPECIES_PAL(PIKACHU_UNOVA_CAP, gMonPalette_Pikachu),
    SPECIES_PAL(PIKACHU_KALOS_CAP, gMonPalette_Pikachu),
    SPECIES_PAL(PIKACHU_ALOLA_CAP, gMonPalette_Pikachu),
    SPECIES_PAL(PIKACHU_PARTNER_CAP, gMonPalette_Pikachu),
    
    SPECIES_PAL(PICHU_SPIKY_EARED, gMonPalette_Pichu),
    ...
    SPECIES_PAL(CASTFORM_SUNNY, gMonPalette_Castform),
    SPECIES_PAL(CASTFORM_RAINY, gMonPalette_Castform),
    SPECIES_PAL(CASTFORM_SNOWY, gMonPalette_Castform),
    ...
    SPECIES_PAL(BURMY_SANDY_CLOAK, gMonPalette_BurmySandy),
    SPECIES_PAL(BURMY_TRASH_CLOAK, gMonPalette_BurmyTrash),

    SPECIES_PAL(WORMADAM_SANDY_CLOAK, gMonPalette_WormadamSandy),
    SPECIES_PAL(WORMADAM_TRASH_CLOAK, gMonPalette_WormadamTrash),

    SPECIES_PAL(CHERRIM_SUNSHINE, gMonPalette_Cherrim),

    SPECIES_PAL(SHELLOS_EAST_SEA, gMonPalette_ShellosE),
    
    SPECIES_PAL(GASTRODON_EAST_SEA, gMonPalette_GastrodonE),
    ...
    SPECIES_PAL(ARCEUS_FIGHTING, gMonPalette_Arceus),
    SPECIES_PAL(ARCEUS_FLYING, gMonPalette_Arceus),
    SPECIES_PAL(ARCEUS_POISON, gMonPalette_Arceus),
    SPECIES_PAL(ARCEUS_GROUND, gMonPalette_Arceus),
    SPECIES_PAL(ARCEUS_ROCK, gMonPalette_Arceus),
    SPECIES_PAL(ARCEUS_BUG, gMonPalette_Arceus),
    SPECIES_PAL(ARCEUS_GHOST, gMonPalette_Arceus),
    SPECIES_PAL(ARCEUS_STEEL, gMonPalette_Arceus),
    SPECIES_PAL(ARCEUS_FIRE, gMonPalette_Arceus),
    SPECIES_PAL(ARCEUS_WATER, gMonPalette_Arceus),
    SPECIES_PAL(ARCEUS_GRASS, gMonPalette_Arceus),
    SPECIES_PAL(ARCEUS_ELECTRIC, gMonPalette_Arceus),
    SPECIES_PAL(ARCEUS_PSYCHIC, gMonPalette_Arceus),
    SPECIES_PAL(ARCEUS_ICE, gMonPalette_Arceus),
    SPECIES_PAL(ARCEUS_DRAGON, gMonPalette_Arceus),
    SPECIES_PAL(ARCEUS_DARK, gMonPalette_Arceus),
    SPECIES_PAL(ARCEUS_FAIRY, gMonPalette_Arceus),

    SPECIES_PAL(BASCULIN_BLUE_STRIPED, gMonPalette_Basculin),

    SPECIES_PAL(DARMANITAN_ZEN_MODE, gMonPalette_DarmanitanZen),

    SPECIES_PAL(DEERLING_SUMMER, gMonPalette_Deerling),
    SPECIES_PAL(DEERLING_AUTUMN, gMonPalette_Deerling),
    SPECIES_PAL(DEERLING_WINTER, gMonPalette_Deerling),

    SPECIES_PAL(SAWSBUCK_SUMMER, gMonPalette_Sawsbuck),
    SPECIES_PAL(SAWSBUCK_AUTUMN, gMonPalette_Sawsbuck),
    SPECIES_PAL(SAWSBUCK_WINTER, gMonPalette_Sawsbuck),
    ...
    SPECIES_PAL(KELDEO_RESOLUTE, gMonPalette_Keldeo),
    ...
    SPECIES_PAL(GRENINJA_ASH, gMonPalette_Greninja),

    SPECIES_PAL(VIVILLON_POLAR, gMonPalette_Vivillon),
    SPECIES_PAL(VIVILLON_TUNDRA, gMonPalette_Vivillon),
    SPECIES_PAL(VIVILLON_CONTINENTAL, gMonPalette_Vivillon),
    SPECIES_PAL(VIVILLON_GARDEN, gMonPalette_Vivillon),
    SPECIES_PAL(VIVILLON_ELEGANT, gMonPalette_Vivillon),
    SPECIES_PAL(VIVILLON_MEADOW, gMonPalette_Vivillon),
    SPECIES_PAL(VIVILLON_MODERN, gMonPalette_Vivillon),
    SPECIES_PAL(VIVILLON_MARINE, gMonPalette_Vivillon),
    SPECIES_PAL(VIVILLON_ARCHIPELAGO, gMonPalette_Vivillon),
    SPECIES_PAL(VIVILLON_HIGH_PLAINS, gMonPalette_Vivillon),
    SPECIES_PAL(VIVILLON_SANDSTORM, gMonPalette_Vivillon),
    SPECIES_PAL(VIVILLON_RIVER, gMonPalette_Vivillon),
    SPECIES_PAL(VIVILLON_MONSOON, gMonPalette_Vivillon),
    SPECIES_PAL(VIVILLON_SAVANNA, gMonPalette_Vivillon),
    SPECIES_PAL(VIVILLON_SUN, gMonPalette_Vivillon),
    SPECIES_PAL(VIVILLON_OCEAN, gMonPalette_Vivillon),
    SPECIES_PAL(VIVILLON_JUNGLE, gMonPalette_Vivillon),
    SPECIES_PAL(VIVILLON_FANCY, gMonPalette_Vivillon),
    SPECIES_PAL(VIVILLON_POKE_BALL, gMonPalette_Vivillon),
    
    SPECIES_PAL(FLABEBE_YELLOW_FLOWER, gMonPalette_Flabebe),
    SPECIES_PAL(FLABEBE_ORANGE_FLOWER, gMonPalette_Flabebe),
    SPECIES_PAL(FLABEBE_BLUE_FLOWER, gMonPalette_Flabebe),
    SPECIES_PAL(FLABEBE_WHITE_FLOWER, gMonPalette_Flabebe),

    SPECIES_PAL(FLOETTE_YELLOW_FLOWER, gMonPalette_Floette),
    SPECIES_PAL(FLOETTE_ORANGE_FLOWER, gMonPalette_Floette),
    SPECIES_PAL(FLOETTE_BLUE_FLOWER, gMonPalette_Floette),
    SPECIES_PAL(FLOETTE_WHITE_FLOWER, gMonPalette_Floette),
    SPECIES_PAL(FLOETTE_ETERNAL_FLOWER, gMonPalette_Floette),

    SPECIES_PAL(FLORGES_YELLOW_FLOWER, gMonPalette_Florges),
    SPECIES_PAL(FLORGES_ORANGE_FLOWER, gMonPalette_Florges),
    SPECIES_PAL(FLORGES_BLUE_FLOWER, gMonPalette_Florges),
    SPECIES_PAL(FLORGES_WHITE_FLOWER, gMonPalette_Florges),

    SPECIES_PAL(FURFROU_HEART_TRIM, gMonPalette_Furfrou),
    SPECIES_PAL(FURFROU_STAR_TRIM, gMonPalette_Furfrou),
    SPECIES_PAL(FURFROU_DIAMOND_TRIM, gMonPalette_Furfrou),
    SPECIES_PAL(FURFROU_DEBUTANTE_TRIM, gMonPalette_Furfrou),
    SPECIES_PAL(FURFROU_MATRON_TRIM, gMonPalette_Furfrou),
    SPECIES_PAL(FURFROU_DANDY_TRIM, gMonPalette_Furfrou),
    SPECIES_PAL(FURFROU_LA_REINE_TRIM, gMonPalette_Furfrou),
    SPECIES_PAL(FURFROU_KABUKI_TRIM, gMonPalette_Furfrou),
    SPECIES_PAL(FURFROU_PHARAOH_TRIM, gMonPalette_Furfrou),
    ...
    SPECIES_PAL(XERNEAS_ACTIVE, gMonPalette_Xerneas),

    SPECIES_PAL(ZYGARDE_10, gMonPalette_Zygarde),
    SPECIES_PAL(ZYGARDE_10_POWER_CONSTRUCT, gMonPalette_Zygarde),
    SPECIES_PAL(ZYGARDE_50_POWER_CONSTRUCT, gMonPalette_Zygarde),
    SPECIES_PAL(ZYGARDE_COMPLETE, gMonPalette_Zygarde),

    SPECIES_PAL(HOOPA_UNBOUND, gMonPalette_HoopaUnbound),

    SPECIES_PAL(ORICORIO_POM_POM, gMonPalette_Oricorio),
    SPECIES_PAL(ORICORIO_PA_U, gMonPalette_Oricorio),
    SPECIES_PAL(ORICORIO_SENSU, gMonPalette_Oricorio),
    ...
    SPECIES_PAL(SILVALLY_FIGHTING, gMonPalette_Silvally),
    SPECIES_PAL(SILVALLY_FLYING, gMonPalette_Silvally),
    SPECIES_PAL(SILVALLY_POISON, gMonPalette_Silvally),
    SPECIES_PAL(SILVALLY_GROUND, gMonPalette_Silvally),
    SPECIES_PAL(SILVALLY_ROCK, gMonPalette_Silvally),
    SPECIES_PAL(SILVALLY_BUG, gMonPalette_Silvally),
    SPECIES_PAL(SILVALLY_GHOST, gMonPalette_Silvally),
    SPECIES_PAL(SILVALLY_STEEL, gMonPalette_Silvally),
    SPECIES_PAL(SILVALLY_FIRE, gMonPalette_Silvally),
    SPECIES_PAL(SILVALLY_WATER, gMonPalette_Silvally),
    SPECIES_PAL(SILVALLY_GRASS, gMonPalette_Silvally),
    SPECIES_PAL(SILVALLY_ELECTRIC, gMonPalette_Silvally),
    SPECIES_PAL(SILVALLY_PSYCHIC, gMonPalette_Silvally),
    SPECIES_PAL(SILVALLY_ICE, gMonPalette_Silvally),
    SPECIES_PAL(SILVALLY_DRAGON, gMonPalette_Silvally),
    SPECIES_PAL(SILVALLY_DARK, gMonPalette_Silvally),
    SPECIES_PAL(SILVALLY_FAIRY, gMonPalette_Silvally),
    ...
    SPECIES_PAL(MINIOR_CORE_RED, gMonPalette_MiniorCore),
    SPECIES_PAL(MINIOR_CORE_ORANGE, gMonPalette_MiniorCore),
    SPECIES_PAL(MINIOR_CORE_YELLOW, gMonPalette_MiniorCore),
    SPECIES_PAL(MINIOR_CORE_GREEN, gMonPalette_MiniorCore),
    SPECIES_PAL(MINIOR_CORE_BLUE, gMonPalette_MiniorCore),
    SPECIES_PAL(MINIOR_CORE_INDIGO, gMonPalette_MiniorCore),
    SPECIES_PAL(MINIOR_CORE_VIOLET, gMonPalette_MiniorCore),

    SPECIES_PAL(MIMIKYU_BUSTED, gMonPalette_MimikyuBusted),

    SPECIES_PAL(NECROZMA_DUSK_MANE, gMonPalette_Necrozma),
    SPECIES_PAL(NECROZMA_DAWN_WINGS, gMonPalette_Necrozma),
    SPECIES_PAL(NECROZMA_ULTRA, gMonPalette_Necrozma),

    SPECIES_PAL(MAGEARNA_ORIGINAL_COLOR, gMonPalette_Magearna),
