const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
    ...
    SPECIES_SPRITE(PIKACHU_COSPLAY, gMonFrontPic_Pikachu),
    SPECIES_SPRITE(PIKACHU_ROCK_STAR, gMonFrontPic_Pikachu),
    SPECIES_SPRITE(PIKACHU_BELLE, gMonFrontPic_Pikachu),
    SPECIES_SPRITE(PIKACHU_POP_STAR, gMonFrontPic_Pikachu),
    SPECIES_SPRITE(PIKACHU_PH_D, gMonFrontPic_Pikachu),
    SPECIES_SPRITE(PIKACHU_LIBRE, gMonFrontPic_Pikachu),
    
    SPECIES_SPRITE(PIKACHU_ORIGINAL_CAP, gMonFrontPic_Pikachu),
    SPECIES_SPRITE(PIKACHU_HOENN_CAP, gMonFrontPic_Pikachu),
    SPECIES_SPRITE(PIKACHU_SINNOH_CAP, gMonFrontPic_Pikachu),
    SPECIES_SPRITE(PIKACHU_UNOVA_CAP, gMonFrontPic_Pikachu),
    SPECIES_SPRITE(PIKACHU_KALOS_CAP, gMonFrontPic_Pikachu),
    SPECIES_SPRITE(PIKACHU_ALOLA_CAP, gMonFrontPic_Pikachu),
    SPECIES_SPRITE(PIKACHU_PARTNER_CAP, gMonFrontPic_Pikachu),
    
    SPECIES_SPRITE(PICHU_SPIKY_EARED, gMonFrontPic_Pichu),
    ...
    SPECIES_SPRITE(CASTFORM_SUNNY, gMonFrontPic_Castform),
    SPECIES_SPRITE(CASTFORM_RAINY, gMonFrontPic_Castform),
    SPECIES_SPRITE(CASTFORM_SNOWY, gMonFrontPic_Castform),
    ...
    SPECIES_SPRITE(BURMY_SANDY_CLOAK, gMonFrontPic_BurmySandy),
    SPECIES_SPRITE(BURMY_TRASH_CLOAK, gMonFrontPic_BurmyTrash),

    SPECIES_SPRITE(WORMADAM_SANDY_CLOAK, gMonFrontPic_WormadamSandy),
    SPECIES_SPRITE(WORMADAM_TRASH_CLOAK, gMonFrontPic_WormadamTrash),

    SPECIES_SPRITE(CHERRIM_SUNSHINE, gMonFrontPic_Cherrim),

    SPECIES_SPRITE(SHELLOS_EAST_SEA, gMonFrontPic_ShellosE),
    
    SPECIES_SPRITE(GASTRODON_EAST_SEA, gMonFrontPic_GastrodonE),
    ...
    SPECIES_SPRITE(BASCULIN_BLUE_STRIPED, gMonFrontPic_Basculin),

    SPECIES_SPRITE(DARMANITAN_ZEN_MODE, gMonFrontPic_DarmanitanZen),
    ...
    SPECIES_SPRITE(SAWSBUCK_SUMMER, gMonFrontPic_Sawsbuck),
    SPECIES_SPRITE(SAWSBUCK_AUTUMN, gMonFrontPic_Sawsbuck),
    SPECIES_SPRITE(SAWSBUCK_WINTER, gMonFrontPic_Sawsbuck),
    ...
    SPECIES_SPRITE(KELDEO_RESOLUTE, gMonFrontPic_Keldeo),
    ...
    SPECIES_SPRITE(GRENINJA_ASH, gMonFrontPic_Greninja),

    SPECIES_SPRITE(VIVILLON_POLAR, gMonFrontPic_Vivillon),
    SPECIES_SPRITE(VIVILLON_TUNDRA, gMonFrontPic_Vivillon),
    SPECIES_SPRITE(VIVILLON_CONTINENTAL, gMonFrontPic_Vivillon),
    SPECIES_SPRITE(VIVILLON_GARDEN, gMonFrontPic_Vivillon),
    SPECIES_SPRITE(VIVILLON_ELEGANT, gMonFrontPic_Vivillon),
    SPECIES_SPRITE(VIVILLON_MEADOW, gMonFrontPic_Vivillon),
    SPECIES_SPRITE(VIVILLON_MODERN, gMonFrontPic_Vivillon),
    SPECIES_SPRITE(VIVILLON_MARINE, gMonFrontPic_Vivillon),
    SPECIES_SPRITE(VIVILLON_ARCHIPELAGO, gMonFrontPic_Vivillon),
    SPECIES_SPRITE(VIVILLON_HIGH_PLAINS, gMonFrontPic_Vivillon),
    SPECIES_SPRITE(VIVILLON_SANDSTORM, gMonFrontPic_Vivillon),
    SPECIES_SPRITE(VIVILLON_RIVER, gMonFrontPic_Vivillon),
    SPECIES_SPRITE(VIVILLON_MONSOON, gMonFrontPic_Vivillon),
    SPECIES_SPRITE(VIVILLON_SAVANNA, gMonFrontPic_Vivillon),
    SPECIES_SPRITE(VIVILLON_SUN, gMonFrontPic_Vivillon),
    SPECIES_SPRITE(VIVILLON_OCEAN, gMonFrontPic_Vivillon),
    SPECIES_SPRITE(VIVILLON_JUNGLE, gMonFrontPic_Vivillon),
    SPECIES_SPRITE(VIVILLON_FANCY, gMonFrontPic_Vivillon),
    SPECIES_SPRITE(VIVILLON_POKE_BALL, gMonFrontPic_Vivillon),
    ...
    SPECIES_SPRITE(FLOETTE_ETERNAL_FLOWER, gMonFrontPic_Floette),
    ...
    SPECIES_SPRITE(FURFROU_HEART_TRIM, gMonFrontPic_Furfrou),
    SPECIES_SPRITE(FURFROU_STAR_TRIM, gMonFrontPic_Furfrou),
    SPECIES_SPRITE(FURFROU_DIAMOND_TRIM, gMonFrontPic_Furfrou),
    SPECIES_SPRITE(FURFROU_DEBUTANTE_TRIM, gMonFrontPic_Furfrou),
    SPECIES_SPRITE(FURFROU_MATRON_TRIM, gMonFrontPic_Furfrou),
    SPECIES_SPRITE(FURFROU_DANDY_TRIM, gMonFrontPic_Furfrou),
    SPECIES_SPRITE(FURFROU_LA_REINE_TRIM, gMonFrontPic_Furfrou),
    SPECIES_SPRITE(FURFROU_KABUKI_TRIM, gMonFrontPic_Furfrou),
    SPECIES_SPRITE(FURFROU_PHARAOH_TRIM, gMonFrontPic_Furfrou),

    SPECIES_SPRITE(MEOWSTIC_F, gMonFrontPic_MeowsticFemale),

    SPECIES_SPRITE(AEGISLASH_BLADE, gMonFrontPic_AegislashBlade),

    SPECIES_SPRITE(PUMPKABOO_SMALL, gMonFrontPic_Pumpkaboo),
    SPECIES_SPRITE(PUMPKABOO_LARGE, gMonFrontPic_Pumpkaboo),
    SPECIES_SPRITE(PUMPKABOO_SUPER, gMonFrontPic_Pumpkaboo),

    SPECIES_SPRITE(GOURGEIST_SMALL, gMonFrontPic_Gourgeist),
    SPECIES_SPRITE(GOURGEIST_LARGE, gMonFrontPic_Gourgeist),
    SPECIES_SPRITE(GOURGEIST_SUPER, gMonFrontPic_Gourgeist),

    SPECIES_SPRITE(XERNEAS_ACTIVE, gMonFrontPic_Xerneas),

    SPECIES_SPRITE(ZYGARDE_10, gMonFrontPic_Zygarde),
    SPECIES_SPRITE(ZYGARDE_10_POWER_CONSTRUCT, gMonFrontPic_Zygarde),
    SPECIES_SPRITE(ZYGARDE_50_POWER_CONSTRUCT, gMonFrontPic_Zygarde),
    SPECIES_SPRITE(ZYGARDE_COMPLETE, gMonFrontPic_Zygarde),

    SPECIES_SPRITE(HOOPA_UNBOUND, gMonFrontPic_HoopaUnbound),

    SPECIES_SPRITE(ORICORIO_POM_POM, gMonFrontPic_Oricorio),
    SPECIES_SPRITE(ORICORIO_PA_U, gMonFrontPic_Oricorio),
    SPECIES_SPRITE(ORICORIO_SENSU, gMonFrontPic_Oricorio),
    ...
    SPECIES_SPRITE(NECROZMA_DUSK_MANE, gMonFrontPic_Necrozma),
    SPECIES_SPRITE(NECROZMA_DAWN_WINGS, gMonFrontPic_Necrozma),
    SPECIES_SPRITE(NECROZMA_ULTRA, gMonFrontPic_Necrozma),

    SPECIES_SPRITE(MAGEARNA_ORIGINAL_COLOR, gMonFrontPic_Magearna),
