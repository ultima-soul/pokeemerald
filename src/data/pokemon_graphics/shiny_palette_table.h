const struct CompressedSpritePalette gMonShinyPaletteTable[] =
{
    ...
    SPECIES_SHINY_PAL(PIKACHU_COSPLAY, gMonShinyPalette_Pikachu),
    SPECIES_SHINY_PAL(PIKACHU_ROCK_STAR, gMonShinyPalette_Pikachu),
    SPECIES_SHINY_PAL(PIKACHU_BELLE, gMonShinyPalette_Pikachu),
    SPECIES_SHINY_PAL(PIKACHU_POP_STAR, gMonShinyPalette_Pikachu),
    SPECIES_SHINY_PAL(PIKACHU_PH_D, gMonShinyPalette_Pikachu),
    SPECIES_SHINY_PAL(PIKACHU_LIBRE, gMonShinyPalette_Pikachu),
    
    SPECIES_SHINY_PAL(PIKACHU_ORIGINAL_CAP, gMonShinyPalette_Pikachu),
    SPECIES_SHINY_PAL(PIKACHU_HOENN_CAP, gMonShinyPalette_Pikachu),
    SPECIES_SHINY_PAL(PIKACHU_SINNOH_CAP, gMonShinyPalette_Pikachu),
    SPECIES_SHINY_PAL(PIKACHU_UNOVA_CAP, gMonShinyPalette_Pikachu),
    SPECIES_SHINY_PAL(PIKACHU_KALOS_CAP, gMonShinyPalette_Pikachu),
    SPECIES_SHINY_PAL(PIKACHU_ALOLA_CAP, gMonShinyPalette_Pikachu),
    SPECIES_SHINY_PAL(PIKACHU_PARTNER_CAP, gMonShinyPalette_Pikachu),
    
    SPECIES_SHINY_PAL(PICHU_SPIKY_EARED, gMonShinyPalette_Pichu),
    ...
    SPECIES_SHINY_PAL(CASTFORM_SUNNY, gMonShinyPalette_Castform),
    SPECIES_SHINY_PAL(CASTFORM_RAINY, gMonShinyPalette_Castform),
    SPECIES_SHINY_PAL(CASTFORM_SNOWY, gMonShinyPalette_Castform),
    ...
    SPECIES_SHINY_PAL(BURMY_SANDY_CLOAK, gMonShinyPalette_BurmySandy),
    SPECIES_SHINY_PAL(BURMY_TRASH_CLOAK, gMonShinyPalette_BurmyTrash),

    SPECIES_SHINY_PAL(WORMADAM_SANDY_CLOAK, gMonShinyPalette_WormadamSandy),
    SPECIES_SHINY_PAL(WORMADAM_TRASH_CLOAK, gMonShinyPalette_WormadamTrash),

    SPECIES_SHINY_PAL(CHERRIM_SUNSHINE, gMonShinyPalette_Cherrim),

    SPECIES_SHINY_PAL(SHELLOS_EAST_SEA, gMonShinyPalette_ShellosE),
    
    SPECIES_SHINY_PAL(GASTRODON_EAST_SEA, gMonShinyPalette_GastrodonE),
    ...
    SPECIES_SHINY_PAL(ARCEUS_FIGHTING, gMonShinyPalette_Arceus),
    SPECIES_SHINY_PAL(ARCEUS_FLYING, gMonShinyPalette_Arceus),
    SPECIES_SHINY_PAL(ARCEUS_POISON, gMonShinyPalette_Arceus),
    SPECIES_SHINY_PAL(ARCEUS_GROUND, gMonShinyPalette_Arceus),
    SPECIES_SHINY_PAL(ARCEUS_ROCK, gMonShinyPalette_Arceus),
    SPECIES_SHINY_PAL(ARCEUS_BUG, gMonShinyPalette_Arceus),
    SPECIES_SHINY_PAL(ARCEUS_GHOST, gMonShinyPalette_Arceus),
    SPECIES_SHINY_PAL(ARCEUS_STEEL, gMonShinyPalette_Arceus),
    SPECIES_SHINY_PAL(ARCEUS_FIRE, gMonShinyPalette_Arceus),
    SPECIES_SHINY_PAL(ARCEUS_WATER, gMonShinyPalette_Arceus),
    SPECIES_SHINY_PAL(ARCEUS_GRASS, gMonShinyPalette_Arceus),
    SPECIES_SHINY_PAL(ARCEUS_ELECTRIC, gMonShinyPalette_Arceus),
    SPECIES_SHINY_PAL(ARCEUS_PSYCHIC, gMonShinyPalette_Arceus),
    SPECIES_SHINY_PAL(ARCEUS_ICE, gMonShinyPalette_Arceus),
    SPECIES_SHINY_PAL(ARCEUS_DRAGON, gMonShinyPalette_Arceus),
    SPECIES_SHINY_PAL(ARCEUS_DARK, gMonShinyPalette_Arceus),
    SPECIES_SHINY_PAL(ARCEUS_FAIRY, gMonShinyPalette_Arceus),

    SPECIES_SHINY_PAL(BASCULIN_BLUE_STRIPED, gMonShinyPalette_Basculin),

    SPECIES_SHINY_PAL(DARMANITAN_ZEN_MODE, gMonShinyPalette_DarmanitanZen),

    SPECIES_SHINY_PAL(DEERLING_SUMMER, gMonShinyPalette_Deerling),
    SPECIES_SHINY_PAL(DEERLING_AUTUMN, gMonShinyPalette_Deerling),
    SPECIES_SHINY_PAL(DEERLING_WINTER, gMonShinyPalette_Deerling),

    SPECIES_SHINY_PAL(SAWSBUCK_SUMMER, gMonShinyPalette_Sawsbuck),
    SPECIES_SHINY_PAL(SAWSBUCK_AUTUMN, gMonShinyPalette_Sawsbuck),
    SPECIES_SHINY_PAL(SAWSBUCK_WINTER, gMonShinyPalette_Sawsbuck),
    ...
    SPECIES_SHINY_PAL(KELDEO_RESOLUTE, gMonShinyPalette_Keldeo),

    SPECIES_SHINY_PAL(MELOETTA_PIROUETTE, gMonShinyPalette_MeloettaPirouette),

    SPECIES_SHINY_PAL(GENESECT_DOUSE_DRIVE, gMonShinyPalette_Genesect),
    SPECIES_SHINY_PAL(GENESECT_SHOCK_DRIVE, gMonShinyPalette_Genesect),
    SPECIES_SHINY_PAL(GENESECT_BURN_DRIVE, gMonShinyPalette_Genesect),
    SPECIES_SHINY_PAL(GENESECT_CHILL_DRIVE, gMonShinyPalette_Genesect),

    SPECIES_SHINY_PAL(GRENINJA_BATTLE_BOND, gMonShinyPalette_Greninja),
    SPECIES_SHINY_PAL(GRENINJA_ASH, gMonShinyPalette_Greninja),

    SPECIES_SHINY_PAL(VIVILLON_POLAR, gMonShinyPalette_Vivillon),
    SPECIES_SHINY_PAL(VIVILLON_TUNDRA, gMonShinyPalette_Vivillon),
    SPECIES_SHINY_PAL(VIVILLON_CONTINENTAL, gMonShinyPalette_Vivillon),
    SPECIES_SHINY_PAL(VIVILLON_GARDEN, gMonShinyPalette_Vivillon),
    SPECIES_SHINY_PAL(VIVILLON_ELEGANT, gMonShinyPalette_Vivillon),
    SPECIES_SHINY_PAL(VIVILLON_MEADOW, gMonShinyPalette_Vivillon),
    SPECIES_SHINY_PAL(VIVILLON_MODERN, gMonShinyPalette_Vivillon),
    SPECIES_SHINY_PAL(VIVILLON_MARINE, gMonShinyPalette_Vivillon),
    SPECIES_SHINY_PAL(VIVILLON_ARCHIPELAGO, gMonShinyPalette_Vivillon),
    SPECIES_SHINY_PAL(VIVILLON_HIGH_PLAINS, gMonShinyPalette_Vivillon),
    SPECIES_SHINY_PAL(VIVILLON_SANDSTORM, gMonShinyPalette_Vivillon),
    SPECIES_SHINY_PAL(VIVILLON_RIVER, gMonShinyPalette_Vivillon),
    SPECIES_SHINY_PAL(VIVILLON_MONSOON, gMonShinyPalette_Vivillon),
    SPECIES_SHINY_PAL(VIVILLON_SAVANNA, gMonShinyPalette_Vivillon),
    SPECIES_SHINY_PAL(VIVILLON_SUN, gMonShinyPalette_Vivillon),
    SPECIES_SHINY_PAL(VIVILLON_OCEAN, gMonShinyPalette_Vivillon),
    SPECIES_SHINY_PAL(VIVILLON_JUNGLE, gMonShinyPalette_Vivillon),
    SPECIES_SHINY_PAL(VIVILLON_FANCY, gMonShinyPalette_Vivillon),
    SPECIES_SHINY_PAL(VIVILLON_POKE_BALL, gMonShinyPalette_Vivillon),
    
    SPECIES_SHINY_PAL(FLABEBE_YELLOW_FLOWER, gMonShinyPalette_Flabebe),
    SPECIES_SHINY_PAL(FLABEBE_ORANGE_FLOWER, gMonShinyPalette_Flabebe),
    SPECIES_SHINY_PAL(FLABEBE_BLUE_FLOWER, gMonShinyPalette_Flabebe),
    SPECIES_SHINY_PAL(FLABEBE_WHITE_FLOWER, gMonShinyPalette_Flabebe),

    SPECIES_SHINY_PAL(FLOETTE_YELLOW_FLOWER, gMonShinyPalette_Floette),
    SPECIES_SHINY_PAL(FLOETTE_ORANGE_FLOWER, gMonShinyPalette_Floette),
    SPECIES_SHINY_PAL(FLOETTE_BLUE_FLOWER, gMonShinyPalette_Floette),
    SPECIES_SHINY_PAL(FLOETTE_WHITE_FLOWER, gMonShinyPalette_Floette),
    SPECIES_SHINY_PAL(FLOETTE_ETERNAL_FLOWER, gMonShinyPalette_Floette),

    SPECIES_SHINY_PAL(FLORGES_YELLOW_FLOWER, gMonShinyPalette_Florges),
    SPECIES_SHINY_PAL(FLORGES_ORANGE_FLOWER, gMonShinyPalette_Florges),
    SPECIES_SHINY_PAL(FLORGES_BLUE_FLOWER, gMonShinyPalette_Florges),
    SPECIES_SHINY_PAL(FLORGES_WHITE_FLOWER, gMonShinyPalette_Florges),

    SPECIES_SHINY_PAL(FURFROU_HEART_TRIM, gMonShinyPalette_Furfrou),
    SPECIES_SHINY_PAL(FURFROU_STAR_TRIM, gMonShinyPalette_Furfrou),
    SPECIES_SHINY_PAL(FURFROU_DIAMOND_TRIM, gMonShinyPalette_Furfrou),
    SPECIES_SHINY_PAL(FURFROU_DEBUTANTE_TRIM, gMonShinyPalette_Furfrou),
    SPECIES_SHINY_PAL(FURFROU_MATRON_TRIM, gMonShinyPalette_Furfrou),
    SPECIES_SHINY_PAL(FURFROU_DANDY_TRIM, gMonShinyPalette_Furfrou),
    SPECIES_SHINY_PAL(FURFROU_LA_REINE_TRIM, gMonShinyPalette_Furfrou),
    SPECIES_SHINY_PAL(FURFROU_KABUKI_TRIM, gMonShinyPalette_Furfrou),
    SPECIES_SHINY_PAL(FURFROU_PHARAOH_TRIM, gMonShinyPalette_Furfrou),
    ...
    SPECIES_SHINY_PAL(XERNEAS_ACTIVE, gMonShinyPalette_Xerneas),

    SPECIES_SHINY_PAL(ZYGARDE_10, gMonShinyPalette_Zygarde),
    SPECIES_SHINY_PAL(ZYGARDE_10_POWER_CONSTRUCT, gMonShinyPalette_Zygarde),
    SPECIES_SHINY_PAL(ZYGARDE_50_POWER_CONSTRUCT, gMonShinyPalette_Zygarde),
    SPECIES_SHINY_PAL(ZYGARDE_COMPLETE, gMonShinyPalette_Zygarde),

    SPECIES_SHINY_PAL(HOOPA_UNBOUND, gMonShinyPalette_HoopaUnbound),

    SPECIES_SHINY_PAL(ORICORIO_POM_POM, gMonShinyPalette_Oricorio),
    SPECIES_SHINY_PAL(ORICORIO_PA_U, gMonShinyPalette_Oricorio),
    SPECIES_SHINY_PAL(ORICORIO_SENSU, gMonShinyPalette_Oricorio),
    ...
    SPECIES_SHINY_PAL(SILVALLY_FIGHTING, gMonShinyPalette_Silvally),
    SPECIES_SHINY_PAL(SILVALLY_FLYING, gMonShinyPalette_Silvally),
    SPECIES_SHINY_PAL(SILVALLY_POISON, gMonShinyPalette_Silvally),
    SPECIES_SHINY_PAL(SILVALLY_GROUND, gMonShinyPalette_Silvally),
    SPECIES_SHINY_PAL(SILVALLY_ROCK, gMonShinyPalette_Silvally),
    SPECIES_SHINY_PAL(SILVALLY_BUG, gMonShinyPalette_Silvally),
    SPECIES_SHINY_PAL(SILVALLY_GHOST, gMonShinyPalette_Silvally),
    SPECIES_SHINY_PAL(SILVALLY_STEEL, gMonShinyPalette_Silvally),
    SPECIES_SHINY_PAL(SILVALLY_FIRE, gMonShinyPalette_Silvally),
    SPECIES_SHINY_PAL(SILVALLY_WATER, gMonShinyPalette_Silvally),
    SPECIES_SHINY_PAL(SILVALLY_GRASS, gMonShinyPalette_Silvally),
    SPECIES_SHINY_PAL(SILVALLY_ELECTRIC, gMonShinyPalette_Silvally),
    SPECIES_SHINY_PAL(SILVALLY_PSYCHIC, gMonShinyPalette_Silvally),
    SPECIES_SHINY_PAL(SILVALLY_ICE, gMonShinyPalette_Silvally),
    SPECIES_SHINY_PAL(SILVALLY_DRAGON, gMonShinyPalette_Silvally),
    SPECIES_SHINY_PAL(SILVALLY_DARK, gMonShinyPalette_Silvally),
    SPECIES_SHINY_PAL(SILVALLY_FAIRY, gMonShinyPalette_Silvally),
    ...
    SPECIES_SHINY_PAL(NECROZMA_DUSK_MANE, gMonShinyPalette_Necrozma),
    SPECIES_SHINY_PAL(NECROZMA_DAWN_WINGS, gMonShinyPalette_Necrozma),
    SPECIES_SHINY_PAL(NECROZMA_ULTRA, gMonShinyPalette_Necrozma),

    SPECIES_SHINY_PAL(MAGEARNA_ORIGINAL_COLOR, gMonShinyPalette_Magearna),
