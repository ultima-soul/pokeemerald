const struct CompressedSpritePalette gMonShinyPaletteTable[] =
{
    ...
    SPECIES_SHINY_PAL(VULPIX_A, gMonShinyPalette_Alolan_Vulpix),
    SPECIES_SHINY_PAL(NINETALES_A, gMonShinyPalette_Alolan_Ninetales),
    ...
    SPECIES_PAL(BONDED_ALTARIA, gMonShinyPalette_Bonded_Altaria),
    SPECIES_PAL(BONDED_AMPHAROS, gMonShinyPalette_Bonded_Ampharos),
    SPECIES_PAL(BONDED_AUDINO, gMonShinyPalette_Bonded_Audino),
    SPECIES_PAL(BONDED_BEEDRILL, gMonShinyPalette_Bonded_Beedrill),
    SPECIES_PAL(BONDED_BLASTOISE, gMonShinyPalette_Bonded_Blastoise),
    SPECIES_PAL(BONDED_BLAZIKEN, gMonShinyPalette_Bonded_Blaziken),
    SPECIES_PAL(BONDED_CHARIZARD, gMonShinyPalette_Bonded_Charizard_y),
    SPECIES_PAL(BONDED_GALLADE, gMonShinyPalette_Bonded_Gallade),
    SPECIES_PAL(BONDED_GARCHOMP, gMonShinyPalette_Bonded_Garchomp),
    SPECIES_PAL(BONDED_GARDEVOIR, gMonShinyPalette_Bonded_Gardevoir),
    SPECIES_PAL(BONDED_GENGAR, gMonShinyPalette_Bonded_Gengar),
    SPECIES_PAL(BONDED_GLALIE, gMonShinyPalette_Bonded_Glalie),
    SPECIES_PAL(BONDED_GYARADOS, gMonShinyPalette_Bonded_Gyarados),
    SPECIES_PAL(BONDED_HERACROSS, gMonShinyPalette_Bonded_Heracross),
    SPECIES_PAL(BONDED_LOPUNNY, gMonShinyPalette_Bonded_Lopunny),
    SPECIES_PAL(BONDED_LUCARIO, gMonShinyPalette_Bonded_Lucario),
    SPECIES_PAL(BONDED_METAGROSS, gMonShinyPalette_Bonded_Metagross),
    SPECIES_PAL(BONDED_PIDGEOT, gMonShinyPalette_Bonded_Pidgeot),
    SPECIES_PAL(BONDED_PINSIR, gMonShinyPalette_Bonded_Pinsir),
    SPECIES_PAL(BONDED_MEWTWO_X, gMonShinyPalette_Bonded_Mewtwo_x),
    SPECIES_PAL(BONDED_SALAMENCE, gMonShinyPalette_Bonded_Salamence),
    SPECIES_PAL(BONDED_SCEPTILE, gMonShinyPalette_Bonded_Sceptile),
    SPECIES_PAL(BONDED_SCIZOR, gMonShinyPalette_Bonded_Scizor),
    SPECIES_PAL(BONDED_STEELIX, gMonShinyPalette_Bonded_Steelix),
    SPECIES_PAL(BONDED_SWAMPERT, gMonShinyPalette_Bonded_Swampert),
    SPECIES_PAL(BONDED_TYRANITAR, gMonShinyPalette_Bonded_Tyranitar),
    SPECIES_PAL(BONDED_VENUSAUR, gMonShinyPalette_Bonded_Venusaur),
};
