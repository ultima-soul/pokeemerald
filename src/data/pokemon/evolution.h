const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_SHELMET]    = {{EVO_LEVEL, 22, SPECIES_ACCELGOR}},
    ...
    [SPECIES_GIRATINA_ORIGIN]     = {{EVO_LEVEL, 26, SPECIES_BONDED_SERPERIOR}},
    [SPECIES_MELOETTA]    = {{EVO_LEVEL, 20, SPECIES_BUNEARY}},
    [SPECIES_BUNEARY]    = {{EVO_LEVEL, 40, SPECIES_LOPUNNY}},
