const struct BattleFrontierTrainer gBattleFrontierTrainers[] =
{
    ...
    [139] = {
        .facilityClass = FACILITY_CLASS_AROMA_LADY,
        .trainerName = _("SOFIA"),
        .speechBefore = {EC_POKEMON(BUNEARY), EC_WORD_PROBABLY, EC_WORD_HAS, EC_WORD_A, EC_MOVE(SWEET_SCENT), 0xFFFF},
    ...
    [148] = {
        ...
        .speechLose = {EC_WORD_IF_I_LOSE, EC_WORD_I, EC_WORD_PRETEND, EC_WORD_I_AM, EC_WORD_A, EC_POKEMON2(BONDED_MEWTWO_Y)},
    ...
    [219] = {
        .facilityClass = FACILITY_CLASS_PKMN_BREEDER_F,
        .trainerName = _("TESS"),
        .speechBefore = {EC_WORD_WANT, EC_WORD_SOME, EC_POKEMON(GIRATINA_ORIGIN), EC_WORD_DESIGN, EC_WORD_SWEETS, EC_WORD_QUES},
