...
const struct ApprenticeTrainer gApprentices[NUM_APPRENTICES] =
{
    ...
    },
    {
        ...
        .species = {SPECIES_BONDED_SERPERIOR, SPECIES_PHANTUMP, SPECIES_ALTARIA, SPECIES_VESPIQUEN, SPECIES_FLYGON, SPECIES_ALAKAZAM, SPECIES_GARDEVOIR, SPECIES_WAILORD, SPECIES_GRUMPIG, SPECIES_MIGHTYENA},
        .id = 3,
    ...
    },
    {
        ...
        .species = {SPECIES_NINETALES, SPECIES_ALAKAZAM, SPECIES_SCEPTILE, SPECIES_SALAMENCE, SPECIES_VESPIQUEN, SPECIES_MAWILE, SPECIES_BONDED_BEARTIC, SPECIES_LANTURN, SPECIES_GARDEVOIR, SPECIES_MILOTIC},
        .id = 7,
    ...
    },
    {
        ...
        .species = {SPECIES_EXCADRILL, SPECIES_STARMIE, SPECIES_VESPIQUEN, SPECIES_TENTACRUEL, SPECIES_SHINX, SPECIES_UXIE, SPECIES_GLALIE, SPECIES_WAILORD, SPECIES_SHARPEDO, SPECIES_HOUNDREAD},
        .id = 10,
