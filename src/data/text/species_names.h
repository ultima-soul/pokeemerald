const u8 gSpeciesNames[][POKEMON_NAME_LENGTH + 1] = {
    ...
    [SPECIES_VULPIX_A] = _("Vulpix-A"),
    [SPECIES_NINETALES_A] = _("NinetalesA"),
    ...
    [SPECIES_BONDED_MEWTWO_Y] = _("Mewtwo-Y"),
    [SPECIES_BLISSEY] = _("Blissey"),
    [SPECIES_ROTOM_FAN] = _("Rotom-F"),
    [SPECIES_ROTOM_MOW] = _("Rotom-M"),
    [SPECIES_ROTOM_HEAT] = _("Rotom-H"),
    [SPECIES_LARVITAR] = _("Larvitar"),
    [SPECIES_PUPITAR] = _("Pupitar"),
    [SPECIES_TYRANITAR] = _("Tyranitar"),
    [SPECIES_ROTOM_WASH] = _("Rotom-W"),
    [SPECIES_ROTOM_FREEZE] = _("Rotom-F"),
    ...
    [SPECIES_GIRATINA_ORIGIN] = _("Giratina-O"),
    [SPECIES_BONDED_SERPERIOR] = _("SerperiorB"),
    ...
    [SPECIES_BONDED_ALTARIA] = _("Altaria"),
    [SPECIES_BONDED_AMPHAROS] = _("Ampharos"),
    [SPECIES_BONDED_AUDINO] = _("Audino"),
    [SPECIES_BONDED_BEEDRILL] = _("Beedrill"),
    [SPECIES_BONDED_BLASTOISE] = _("Blastoise"),
    [SPECIES_BONDED_BLAZIKEN] = _("Blaziken"),
    [SPECIES_BONDED_CHARIZARD] = _("Charizard"),
    [SPECIES_BONDED_GALLADE] = _("Gallade"),
    [SPECIES_BONDED_GARCHOMP] = _("Garchomp"),
    [SPECIES_BONDED_GARDEVOIR] = _("Gardevoir"),
    [SPECIES_BONDED_GENGAR] = _("Gengar"),
    [SPECIES_BONDED_GLALIE] = _("Glalie"),
    [SPECIES_BONDED_GYARADOS] = _("Gyarados"),
    [SPECIES_BONDED_HERACROSS] = _("Heracross"),
    [SPECIES_BONDED_LOPUNNY] = _("Lopunny"),
    [SPECIES_BONDED_LUCARIO] = _("Lucario"),
    [SPECIES_BONDED_METAGROSS] = _("Metagross"),
    [SPECIES_BONDED_PIDGEOT] = _("Pidgeot"),
    [SPECIES_BONDED_PINSIR] = _("Pinsir"),
    [SPECIES_BONDED_MEWTWO_X] = _("Mewtwo-X"),
    [SPECIES_BONDED_SALAMENCE] = _("Salamence"),
    [SPECIES_BONDED_SCEPTILE] = _("SCeptile"),
    [SPECIES_BONDED_SCIZOR] = _("Scizor"),
    [SPECIES_BONDED_STEELIX] = _("Steelix"),
    [SPECIES_BONDED_SWAMPERT] = _("Swampert"),
    [SPECIES_BONDED_TYRANITAR] = _("Tyranitar"),
    [SPECIES_BONDED_VENUSAUR] = _("Venusaur"),
};
