...
const u16 gEasyChatWordsByLetter_C[] = {
    ...
    EC_WORD_CARES,
    EC_POKEMON(CARVANHA),
    EC_POKEMON(WHIMSICOTT),
    EC_WORD_CASE,
    EC_POKEMON(ALOLAN_MAROWAK),
    EC_POKEMON2(SNIVY),
    EC_WORD_CAUSE,
    EC_POKEMON2(CELEBI),
    EC_WORD_CENTER,
...
const u16 gEasyChatWordsByLetter_G[] = {
    ...
    -1, 2, // Doubled pokemon species name
    EC_POKEMON(MEOWSTIC_M),
    EC_POKEMON2(MEOWSTIC_M),
    EC_WORD_GREAT,
    EC_WORD_GREEN,
    -1, 2, // Doubled pokemon species name
    EC_POKEMON(MUDBRAY),
...
const u16 gEasyChatWordsByLetter_K[] = {
    ...
    EC_MOVE(KINESIS),
    -1, 2, // Doubled pokemon species name
    EC_POKEMON(HOUNDREAD),
    EC_POKEMON2(HOUNDREAD),
    EC_POKEMON2(KINGLER),
    EC_POKEMON(KIRLIA),
    EC_MOVE2(KNOCK_OFF),
    EC_WORD_KNOCKOUT,
...
const u16 gEasyChatWordsByLetter_N[] = {
    ...
    EC_WORD_NOPE,
    EC_WORD_NORMAL,
    EC_POKEMON(SANDSHREW_A),
    EC_WORD_NOT,
    EC_WORD_NOT_VERY,
    EC_WORD_NOTHING,
    EC_WORD_NOW,
    EC_POKEMON(MANETHUNDR),
    EC_POKEMON(MIENFOO),
};
...
const u16 gEasyChatWordsByLetter_R[] = {
    ...
    EC_WORD_RARE,
    EC_WORD_RATHER,
    EC_POKEMON2(NINETALES_A),
    EC_POKEMON2(VULPIX_A),
    EC_POKEMON(RAYQUAZA),
    EC_MOVE2(RAZOR_LEAF),
    EC_MOVE(RAZOR_WIND),
    EC_WORD_READY,
...
const u16 gEasyChatWordsByLetter_S[] = {
    ...
    EC_POKEMON2(MEDIREIGN),
    EC_POKEMON(SHUPPET),
    EC_WORD_SIBLINGS,
    EC_WORD_SIGH,
    EC_MOVE(SIGNAL_BEAM),
    EC_POKEMON(LILLIGANT),
    EC_WORD_SILKY,
    EC_WORD_SILVER,
    EC_MOVE(SILVER_WIND),
    EC_WORD_SIMPLE,
    ...
    EC_POKEMON2(GIBLE),
    EC_POKEMON2(ROTOM_HEAT),
    EC_WORD_SUMMER,
    EC_WORD_SUNDAY,
    EC_POKEMON2(JAWGUILE),
    EC_POKEMON2(SCIMITEYE),
    EC_MOVE2(SUNNY_DAY),
    EC_WORD_SUPER,
    EC_MOVE(SUPER_FANG),
    EC_MOVE2(SUPERPOWER),
...
const u16 gEasyChatWordsByLetter_V[] = {
    ...
    EC_WORD_VIEWING,
    EC_POKEMON(FLETCHINDR),
    -1, 2, // Doubled pokemon species name
    EC_POKEMON(DECIDUEYE),
    EC_POKEMON2(DECIDUEYE),
    EC_MOVE2(VINE_WHIP),
...
const u16 gEasyChatWordsByLetter_W[] = {
    ...
    -1, 2, // Doubled pokemon species name
    EC_POKEMON(BONDED_BEARTIC),
    EC_POKEMON2(BONDED_BEARTIC),
    EC_WORD_WEIRD,
    EC_WORD_WELCOME,
    EC_WORD_WELL,
    EC_WORD_WELL_THEN,
