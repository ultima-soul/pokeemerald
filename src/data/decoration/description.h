...
const u8 DecorDesc_SEWADDLE_DOLL[] = _(
    "A SEWADDLE doll.\n"
        "Place it on a mat\n"
        "or a desk.");
...
const u8 DecorDesc_SNOVER_DOLL[] = _(
    "A SNOVER doll.\n"
        "Place it on a mat\n"
        "or a desk.");

const u8 DecorDesc_BASCULIN_DOLL[] = _(
    "A BASCULIN doll.\n"
        "Place it on a mat\n"
        "or a desk.");

const u8 DecorDesc_FROAKIE_DOLL[] = _(
    "A FROAKIE doll.\n"
        "Place it on a mat\n"
        "or a desk.");

const u8 DecorDesc_TYRUNT_DOLL[] = _(
    "A TYRUNT doll.\n"
        "Place it on a mat\n"
        "or a desk.");
...
const u8 DecorDesc_GOTHITA_DOLL[] = _(
    "A GOTHITA doll.\n"
        "Place it on a mat\n"
        "or a desk.");
...
const u8 DecorDesc_GURDURR_DOLL[] = _(
    "A GURDURR doll.\n"
        "Place it on a mat\n"
        "or a desk.");

const u8 DecorDesc_TIMBURR_DOLL[] = _(
    "A TIMBURR doll.\n"
        "Place it on a mat\n"
        "or a desk.");

const u8 DecorDesc_BOLDORE_DOLL[] = _(
    "A BOLDORE doll.\n"
        "Place it on a mat\n"
        "or a desk.");

const u8 DecorDesc_ROGGENROLA_DOLL[] = _(
    "A ROGGENROLA doll.\n"
        "Place it on a mat\n"
        "or a desk.");

const u8 DecorDesc_CARRACOSTA_DOLL[] = _(
    "An CARRACOSTA doll.\n"
        "Place it on a mat\n"
        "or a desk.");
...
const u8 DecorDesc_DARKRAI_DOLL[] = _(
    "A DARKRAI doll.\n"
        "Place it on a mat\n"
        "or a desk.");

const u8 DecorDesc_DUOSION_DOLL[] = _(
    "A DUOSION doll.\n"
        "Place it on a mat\n"
        "or a desk.");

const u8 DecorDesc_PANGORO_DOLL[] = _(
    "A PANGORO doll.\n"
        "Place it on a mat\n"
        "or a desk.");
