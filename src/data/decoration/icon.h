const u32 *const gDecorIconTable[][2] = 
{
    ...
    [DECOR_SEWADDLE_DOLL]      = {NULL, NULL},
    [DECOR_PIKACHU_DOLL]    = {NULL, NULL},
    [DECOR_MARILL_DOLL]     = {NULL, NULL},
    [DECOR_TOGEPI_DOLL]     = {NULL, NULL},
    [DECOR_CYNDAQUIL_DOLL]  = {NULL, NULL},
    [DECOR_SNOVER_DOLL]  = {NULL, NULL},
    [DECOR_BASCULIN_DOLL]   = {NULL, NULL},
    [DECOR_FROAKIE_DOLL] = {NULL, NULL},
    [DECOR_TYRUNT_DOLL]     = {NULL, NULL},
    [DECOR_CLEFAIRY_DOLL]   = {NULL, NULL},
    [DECOR_DITTO_DOLL]      = {NULL, NULL},
    [DECOR_GOTHITA_DOLL]   = {NULL, NULL},
    [DECOR_TREECKO_DOLL]    = {NULL, NULL},
    [DECOR_TORCHIC_DOLL]    = {NULL, NULL},
    [DECOR_MUDKIP_DOLL]     = {NULL, NULL},
    [DECOR_GURDURR_DOLL]    = {NULL, NULL},
    [DECOR_TIMBURR_DOLL]     = {NULL, NULL},
    [DECOR_BOLDORE_DOLL]     = {NULL, NULL},
    [DECOR_ROGGENROLA_DOLL]    = {NULL, NULL},
    [DECOR_CARRACOSTA_DOLL]    = {NULL, NULL},
    [DECOR_SKITTY_DOLL]     = {NULL, NULL},
    [DECOR_SWABLU_DOLL]     = {NULL, NULL},
    [DECOR_GIRATINA_ORIGIN_DOLL]     = {NULL, NULL},
    [DECOR_DUOSION_DOLL]      = {NULL, NULL},
    [DECOR_PANGORO_DOLL]     = {NULL, NULL},
