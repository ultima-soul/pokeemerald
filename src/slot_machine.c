...
enum
{
    ...
    SLOT_MACHINE_TAG_CARRACOSTA,
    SLOT_MACHINE_TAG_DUOSION,
...
enum
{
    ...
    SLOT_MACHINE_MATCHED_DUOSION,
    SLOT_MACHINE_MATCHED_CARRACOSTA,
...
// tentative name
const u8 gBiasTags[] = {
  SLOT_MACHINE_TAG_REPLAY, SLOT_MACHINE_TAG_CHERRY, SLOT_MACHINE_TAG_DUOSION, SLOT_MACHINE_TAG_CARRACOSTA, SLOT_MACHINE_TAG_POWER, SLOT_MACHINE_TAG_7_RED, SLOT_MACHINE_TAG_7_RED, SLOT_MACHINE_TAG_7_RED
};
...
const u16 gLuckyFlagSettings_NotTop3[] = {
    LUCKY_BIAS_POWER, LUCKY_BIAS_CARRACOSTA, LUCKY_BIAS_DUOSION, LUCKY_BIAS_CHERRY, LUCKY_BIAS_REPLAY
};
...
const u16 gSlotMatchFlags[] = {
    ...
    1 << SLOT_MACHINE_MATCHED_DUOSION,
    1 << SLOT_MACHINE_MATCHED_CARRACOSTA,
