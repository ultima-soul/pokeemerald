...
static const struct PokemonJumpMons gPkmnJumpSpecies[] =
{
    ...
    { .species = SPECIES_SNIVY,   .unk2 = 1, },
    { .species = SPECIES_SERVINE,    .unk2 = 1, },
    { .species = SPECIES_WEEDLE,     .unk2 = 1, },
    { .species = SPECIES_KAKUNA,     .unk2 = 1, },
    { .species = SPECIES_VULPIX_A,    .unk2 = 1, },
    { .species = SPECIES_NINETALES_A,   .unk2 = 1, },
    ...
    { .species = SPECIES_FROAKIE, .unk2 = 2, },
    { .species = SPECIES_ROWLET,     .unk2 = 2, },
    { .species = SPECIES_BIDOOF,      .unk2 = 1, },
    { .species = SPECIES_TYRUNT,     .unk2 = 0, },
    { .species = SPECIES_COMBEE,    .unk2 = 2, },
    { .species = SPECIES_PURRLOIN,     .unk2 = 1, },
    { .species = SPECIES_GROWLITHE,  .unk2 = 1, },
    { .species = SPECIES_PIDOVE,    .unk2 = 2, },
    { .species = SPECIES_VENIPEDE, .unk2 = 2, },
    { .species = SPECIES_DUCKLETT,   .unk2 = 1, },
    { .species = SPECIES_KRABBY,     .unk2 = 1, },
    { .species = SPECIES_CUBCHOO,  .unk2 = 2, },
    { .species = SPECIES_CUBONE,     .unk2 = 0, },
    { .species = SPECIES_DITTO,      .unk2 = 2, },
    { .species = SPECIES_EEVEE,      .unk2 = 0, },
    { .species = SPECIES_SKORUPI,    .unk2 = 1, },
    { .species = SPECIES_SKRELP,     .unk2 = 1, },
    { .species = SPECIES_SNOVER,  .unk2 = 2, },
    { .species = SPECIES_CYNDAQUIL,  .unk2 = 1, },
    { .species = SPECIES_BASCULIN,   .unk2 = 0, },
    { .species = SPECIES_SPINARAK,   .unk2 = 1, },
    { .species = SPECIES_SEWADDLE,      .unk2 = 0, },
    { .species = SPECIES_SWADLOON,     .unk2 = 0, },
    { .species = SPECIES_LEAVANNY,  .unk2 = 2, },
    { .species = SPECIES_TOGEPI,     .unk2 = 2, },
    { .species = SPECIES_MAREEP,     .unk2 = 0, },
    { .species = SPECIES_TREVENANT,  .unk2 = 2, },
    { .species = SPECIES_MARILL,     .unk2 = 2, },
    { .species = SPECIES_SCIMITEYE,    .unk2 = 2, },
    { .species = SPECIES_WOOPER,     .unk2 = 2, },
    { .species = SPECIES_JOLTIK,     .unk2 = 2, },
    { .species = SPECIES_POPPLIO,   .unk2 = 0, },
    { .species = SPECIES_MEDIREIGN,    .unk2 = 2, },
    { .species = SPECIES_TEDDIURSA,  .unk2 = 0, },
    { .species = SPECIES_BRONZOR,     .unk2 = 2, },
    { .species = SPECIES_SWINUB,     .unk2 = 0, },
    { .species = SPECIES_HOUNDOUR,   .unk2 = 1, },
    { .species = SPECIES_LITLEO,     .unk2 = 0, },
    { .species = SPECIES_PORYGON2,   .unk2 = 0, },
    { .species = SPECIES_TYROGUE,    .unk2 = 1, },
    { .species = SPECIES_GOTHITA,   .unk2 = 2, },
    { .species = SPECIES_GOTHORITA,     .unk2 = 1, },
    { .species = SPECIES_GOTHITELLE,      .unk2 = 1, },
    ...
    { .species = SPECIES_PETILIL,    .unk2 = 1, },
    { .species = SPECIES_LILLIGANT,    .unk2 = 2, },
    { .species = SPECIES_WHIMSICOTT,    .unk2 = 2, },
    { .species = SPECIES_DUOSION,      .unk2 = 2, },
    { .species = SPECIES_PANGORO,     .unk2 = 1, },
    { .species = SPECIES_RALTS,      .unk2 = 0, },
    { .species = SPECIES_KIRLIA,     .unk2 = 0, },
    { .species = SPECIES_RIOLU,    .unk2 = 2, },
    { .species = SPECIES_SHROOMISH,  .unk2 = 2, },
    { .species = SPECIES_AMAURA,    .unk2 = 1, },
    { .species = SPECIES_MELOETTA,    .unk2 = 0, },
    { .species = SPECIES_CARRACOSTA,    .unk2 = 2, },
    ...
    { .species = SPECIES_SALANDIT,     .unk2 = 1, },
    { .species = SPECIES_SALAZZLE,      .unk2 = 1, },
    { .species = SPECIES_RHYPERIOR,    .unk2 = 0, },
    { .species = SPECIES_GALLADE,   .unk2 = 0, },
    { .species = SPECIES_GIRATINA,    .unk2 = 2, },
    { .species = SPECIES_GIRATINA_ORIGIN,     .unk2 = 2, },
    { .species = SPECIES_MANETHUNDR,      .unk2 = 2, },
    { .species = SPECIES_SANDSLASH_A,    .unk2 = 2, },
    { .species = SPECIES_SPOINK,     .unk2 = 0, },
    { .species = SPECIES_TRAPINCH,   .unk2 = 2, },
    { .species = SPECIES_CACNEA,     .unk2 = 2, },
    { .species = SPECIES_ANORITH,    .unk2 = 1, },
    { .species = SPECIES_TIMBURR,     .unk2 = 0, },
    { .species = SPECIES_SNORUNT,    .unk2 = 0, },
    { .species = SPECIES_AZELF,   .unk2 = 1, },
