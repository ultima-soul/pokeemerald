...
static const u16 sStatusIconColors[] =
{
    ...
    [PAL_STATUS_BRN] = RGB(23, 0, 0),
};

static const struct WindowTemplate sHealthboxWindowTemplate = {0, 0, 0, 8, 2, 0, 0}; // width = 8, height = 2
static const struct WindowTemplate sHPWindowTemplate = {1, 0, 0, 4, 2, 0, 0}; // width = 4, height = 2
...
static void UpdateNickInHealthbox(u8 healthboxSpriteId, struct Pokemon *mon)
{
    ...
    default:
        ...
        windowTileData = AddTextPrinterAndCreateWindowOnHealthbox(gDisplayedStringBattle, 2, 3, 0, &windowId);
        break;
    case MON_MALE:
