...
const u32 gMonFrontPic_Vivillon[] = INCBIN_U32("graphics/pokemon/machamp/anim_front.4bpp.lz");
...
const u32 gMonFrontPic_Phantump[] = INCBIN_U32("graphics/pokemon/xatu/anim_front.4bpp.lz");
