...
const u8 *const gMonIconTable[] =
{
    ...
    [SPECIES_COMBEE] = gMonIcon_Psyduck,
    ...
    [SPECIES_BUIZEL] = gMonIcon_Horsea,
    [SPECIES_FLOATZEL] = gMonIcon_Seadra,
    [SPECIES_DRILLBUR] = gMonIcon_Goldeen,
    ...
    [SPECIES_FOONGUS] = gMonIcon_Magmar,
    [SPECIES_PINSIR] = gMonIcon_Pinsir,
    [SPECIES_AMOONGUSS] = gMonIcon_Tauros,
    ...
    [SPECIES_BASCULIN] = gMonIcon_Totodile,
    [SPECIES_WIMPOD] = gMonIcon_Croconaw,
    [SPECIES_GOLISOPOD] = gMonIcon_Feraligatr,
    ...
    [SPECIES_MIMIKYU] = gMonIcon_Crobat,
    [SPECIES_CHINCHOU] = gMonIcon_Chinchou,
    [SPECIES_LANTURN] = gMonIcon_Lanturn,
    [SPECIES_SEWADDLE] = gMonIcon_Pichu,
    [SPECIES_SWADLOON] = gMonIcon_Cleffa,
    [SPECIES_LEAVANNY] = gMonIcon_Igglybuff,
    ...
    [SPECIES_DUOSION] = gMonIcon_Lotad,
    [SPECIES_REUNICLUS] = gMonIcon_Lombre,
    [SPECIES_PANCHAM] = gMonIcon_Ludicolo,
    [SPECIES_PANGORO] = gMonIcon_Seedot,
    ...
    [SPECIES_PORYGONZ] = gMonIcon_Camerupt,
    ...
    [SPECIES_CRESSELIA] = gMonIcon_Swalot,
