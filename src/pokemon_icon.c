...
const u8 *const gMonIconTable[] =
{
    ...
    [SPECIES_UNOWN_C] = gMonIcon_Bonded_Ampharos,
    [SPECIES_UNOWN_D] = gMonIcon_Bonded_Audino,
    [SPECIES_UNOWN_E] = gMonIcon_Bonded_Beedrill,
    [SPECIES_UNOWN_F] = gMonIcon_Bonded_Blastoise,
    [SPECIES_UNOWN_G] = gMonIcon_Bonded_Blaziken,
    [SPECIES_UNOWN_H] = gMonIcon_Bonded_Charizard_y,
    [SPECIES_UNOWN_I] = gMonIcon_Bonded_Gallade,
    [SPECIES_UNOWN_J] = gMonIcon_Bonded_Garchomp,
    [SPECIES_UNOWN_K] = gMonIcon_Bonded_Gardevoir,
    [SPECIES_UNOWN_L] = gMonIcon_Bonded_Gengar,
    [SPECIES_UNOWN_M] = gMonIcon_Bonded_Glalie,
    [SPECIES_UNOWN_N] = gMonIcon_Bonded_Gyarados,
    [SPECIES_UNOWN_O] = gMonIcon_Bonded_Heracross,
    [SPECIES_UNOWN_P] = gMonIcon_Bonded_Lopunny,
    [SPECIES_UNOWN_Q] = gMonIcon_Bonded_Lucario,
    [SPECIES_UNOWN_R] = gMonIcon_Bonded_Metagross,
    [SPECIES_UNOWN_S] = gMonIcon_Bonded_Pidgeot,
    [SPECIES_UNOWN_T] = gMonIcon_Bonded_Pinsir,
    [SPECIES_UNOWN_U] = gMonIcon_Bonded_Mewtwo_x,
    [SPECIES_UNOWN_V] = gMonIcon_Bonded_Salamence,
    [SPECIES_UNOWN_W] = gMonIcon_Bonded_Sceptile,
    [SPECIES_UNOWN_X] = gMonIcon_Bonded_Scizor,
    [SPECIES_UNOWN_Y] = gMonIcon_Bonded_Steelix,
    [SPECIES_UNOWN_Z] = gMonIcon_Bonded_Swampert,
    [SPECIES_UNOWN_EMARK] = gMonIcon_Bonded_Tyranitar,
    [SPECIES_UNOWN_QMARK] = gMonIcon_Bonded_Venusaur,
};
