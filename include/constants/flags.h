...
#define FLAG_ROGGENROLA_FLED_FORTREE            0x127
...
#define FLAG_DEFEATED_SCRAGGY_1_NEW_MAUVILLE 0x1C1
#define FLAG_DEFEATED_SCRAGGY_2_NEW_MAUVILLE 0x1C2
#define FLAG_DEFEATED_SCRAGGY_3_NEW_MAUVILLE 0x1C3
#define FLAG_DEFEATED_SCRAFTY_1_AQUA_HIDEOUT 0x1C4
...
#define FLAG_HIDE_LITTLEROOT_TOWN_PLAYERS_HOUSE_FLETCHINDR_1          0x2F2
#define FLAG_HIDE_LITTLEROOT_TOWN_PLAYERS_HOUSE_FLETCHINDR_2          0x2F3
...
#define FLAG_HIDE_LITTLEROOT_TOWN_BIRCHS_LAB_POKEBALL_BASCULIN      0x32C
...
#define FLAG_HIDE_LITTLEROOT_TOWN_BIRCHS_LAB_POKEBALL_SNOVER     0x346
...
#define FLAG_HIDE_BATTLE_FRONTIER_GIBLE                         0x34A
...
#define FLAG_HIDE_LITTLEROOT_TOWN_MAYS_HOUSE_2F_SEWADDLE_DOLL          0x351
...
#define FLAG_HIDE_FALLARBOR_CARRACOSTA                                 0x38B
...
#define FLAG_VISITED_OLDALE_TOWN                    (SYSTEM_FLAGS + 0x12)
#define FLAG_VISITED_DEWFORD_TOWN                   (SYSTEM_FLAGS + 0x13)
#define FLAG_VISITED_LAVARIDGE_TOWN                 (SYSTEM_FLAGS + 0x14)
#define FLAG_VISITED_FALLARBOR_TOWN                 (SYSTEM_FLAGS + 0x15)
#define FLAG_VISITED_VERDANTURF_TOWN                (SYSTEM_FLAGS + 0x16)
#define FLAG_VISITED_PACIFIDLOG_TOWN                (SYSTEM_FLAGS + 0x17)
#define FLAG_VISITED_PETALBURG_CITY                 (SYSTEM_FLAGS + 0x18)
#define FLAG_VISITED_SLATEPORT_CITY                 (SYSTEM_FLAGS + 0x19)
#define FLAG_VISITED_MAUVILLE_CITY                  (SYSTEM_FLAGS + 0x1A)
#define FLAG_VISITED_RUSTBORO_CITY                  (SYSTEM_FLAGS + 0x1B)
#define FLAG_VISITED_FORTREE_CITY                   (SYSTEM_FLAGS + 0x1C)
#define FLAG_VISITED_LILYCOVE_CITY                  (SYSTEM_FLAGS + 0x1D)
#define FLAG_VISITED_MOSSDEEP_CITY                  (SYSTEM_FLAGS + 0x1E)
#define FLAG_VISITED_SOOTOPOLIS_CITY                (SYSTEM_FLAGS + 0x1F)
#define FLAG_VISITED_EVER_GRANDE_CITY               (SYSTEM_FLAGS + 0x20)

#define FLAG_IS_CHAMPION                            (SYSTEM_FLAGS + 0x21) // Seems to be related to linking.
#define FLAG_NURSE_UNION_ROOM_REMINDER              (SYSTEM_FLAGS + 0x22)
